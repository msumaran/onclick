...
function ContactsList(props) {
	...
	const contacts = useSelector(({ TagsApp }) => TagsApp.tags.entities);
	const selectedContactIds = useSelector(({ TagsApp }) => TagsApp.tags.selectedContactIds);
	const searchText = useSelector(({ TagsApp }) => TagsApp.tags.searchText);
