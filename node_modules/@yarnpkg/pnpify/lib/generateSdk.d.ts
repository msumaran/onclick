...
export declare type MapKey<S> = S extends Map<infer K, infer V> ? K : never;
...
export declare type SupportedSdk = 'eslint' | 'prettier' | 'typescript-language-server' | 'typescript' | 'stylelint' | 'svelte-language-server';
export declare type BaseSdks = Array<[SupportedSdk, GenerateBaseWrapper]>;
export declare type IntegrationSdks = Array<[SupportedSdk, GenerateIntegrationWrapper | null]>;
